...
export const Login: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      // Add a 5-second timeout for the network call
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm opacity-50">Resume your quest for knowledge.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            <label className="text-[10px] uppercase font-black tracking-widest opacity-40 ml-2 mb-1 block">Identification</label>
          ...
          <div>
            <label className="text-[10px] uppercase font-black tracking-widest opacity-40 ml-2 mb-1 block">Security Clear</label>
            <div className="relative">
        ...
        <div className="mt-8 text-center space-y-4">
          <p className="text-sm opacity-50">
            First time cadet? <Link to="/signup" className="text-[var(--color-primary)] font-bold">Join the Force</Link>
          </p>
